...
data={'pin':'9345','account.no':'779484173712','phone.no':'+919390432145','amount':10000}
...
def sms(body,phone):
    account_sid='AC9613640483fac384f6e098ff6348af05'
    auth_token='992fdce968855217178505a5bd375c5b'
    client=Client(account_sid,auth_token)
    message=client.messages.create(body=body,from_='+18154543890',to='+919390432145')
    print(message.sid)
...
frame1=Frame(root,width=1080,height=720,relief=RIDGE,borderwidth=5,bg='#E1AFD1')
frame1.place(x=0,y=0)

l1=Label(root,text='MRCET ATM',font=("ArialGreek 20 bold"),bg='#F0F3FF')
l1.place(x=430,y=260)

l2=Label(root,text='Please Insert the ATM card',font=("ArialGreek 15"),bg='#F0F3FF')
...
def imageCapture():
    ...
    frame2=Frame(imageCapture,width=1080,height=720,relief=RIDGE,borderwidth=5,bg='#E1AFD1')
    frame2.place(x=0,y=0)

    l1=Label(imageCapture,text='MRCET ATM',font=("ArialGreek 20 bold"),bg='#F0F3FF')
    l1.place(x=430,y=260)

    l2=Label(imageCapture,text='please click the continue button for further steps',font=("ArialGreek 15"),bg='#F0F3FF')
    ...
    def imagetodatabase():
        ...
        l3=Label(imageCapture,text='pleas click the ok button for atm operations',font=("ArialGreek 15"),bg='#F0F3FF')
...
def pincheck():
    ...
    frame2=Frame(pincheck,width=1080,height=720,relief=RIDGE,borderwidth=5,bg='#E1AFD1')
    frame2.place(x=0,y=0)

    l1=Label(pincheck,text='MRCET ATM',font=("ArialGreek 20 bold"),bg='#E1AFD1')
    l1.place(x=430,y=260)
    
    l2=Label(pincheck,text='please enter the ATM PIN number',font=("ArialGreek 15"),bg='#E1AFD1')
...
def atmoperations():
    ...
    frame2=Frame(atmoperations,width=1080,height=720,relief=RIDGE,borderwidth=5,bg='#E1AFD1')
    frame2.place(x=0,y=0)

    l1=Label(atmoperations,text='MRCET ATM',font=("ArialGreek 20 bold"),bg='#E1AFD1')
    l1.place(x=430,y=260)
    
    l2=Label(atmoperations,text='please select the operation to perform',font=("ArialGreek 15"),bg='#E1AFD1')
    l2.place(x=350,y=320)
...
def withdrawal():
    ...
    frame2=Frame(withdrawal,width=1080,height=720,relief=RIDGE,borderwidth=5,bg='#E1AFD1')
    frame2.place(x=0,y=0)

    l1=Label(withdrawal,text='MRCET ATM',font=("ArialGreek 20 bold"),bg='#E1AFD1')
    l1.place(x=430,y=260)
    l2=Label(withdrawal,text='Enter the amount',font=("ArialGreek 15"),bg='#E1AFD1')
    l2.place(x=350,y=320)
...
def deposit():
    ...
    frame2=Frame(deposit,width=1080,height=720,relief=RIDGE,borderwidth=5,bg='#E1AFD1')
    frame2.place(x=0,y=0)

    l1=Label(deposit,text='MRCET ATM',font=("ArialGreek 20 bold"),bg='#E1AFD1')
    l1.place(x=430,y=260)
    l2=Label(deposit,text='Deposit Amount here',font=("ArialGreek 15"),bg='#E1AFD1')
    l2.place(x=410,y=320)
    l3=Label(deposit,text='Account Number',font=("ArialGreek 15"),bg='#E1AFD1')
    l3.place(x=300,y=400)

    e1=tk.Entry(deposit,show=None,font=('Arial',15))
    e1.place(x=500,y=400)

    l4=Label(deposit,text='Enter Amount',font=("ArialGreek 15"),bg='#E1AFD1')
...
def recharge():
    ...
    frame2=Frame(recharge,width=1080,height=720,relief=RIDGE,borderwidth=5,bg='#E1AFD1')
    frame2.place(x=0,y=0)

    l1=Label(recharge,text='MRCET ATM',font=("ArialGreek 20 bold"),bg='#E1AFD1')
    l1.place(x=430,y=260)
    l2=Label(recharge,text='Recharge Mobial here',font=("ArialGreek 15"),bg='#E1AFD1')
    l2.place(x=410,y=320)
    l3=Label(recharge,text='Phone NO',font=("ArialGreek 15"),bg='#E1AFD1')
    l3.place(x=300,y=400)

    e1=tk.Entry(recharge,show=None,font=('Arial',15))
    e1.place(x=500,y=400)

    l4=Label(recharge,text='Enter Amount',font=("ArialGreek 15"),bg='#E1AFD1')
    l4.place(x=300,y=450)
